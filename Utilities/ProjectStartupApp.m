classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Applied-Linear-Algebra";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Applied Linear Algebra';
            ...
            app.Image.ImageSource = 'SIZ-diagram-complete.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Applied Linear Algebra';
