...
if isMATLABReleaseOlderThan("R2023b")
    ...
    try 
        if exist(fullfile("Utilities","OldVersions","ReadMyWriting23a.mlx"),"file")
            movefile(fullfile("Scripts","ReadMyWriting.mlx"), fullfile("Utilities","OldVersions","ReadMyWriting23b.mlx"))
            movefile(fullfile("Utilities","OldVersions","ReadMyWriting23a.mlx"),fullfile("Scripts","ReadMyWriting.mlx"))
        end
    catch
        disp("Failed to move ReadMyWriting.mlx.")
        disp("Be prepared to replace calls to imageViewer with imtool.")
    end
end
ProjectStartupApp;
end